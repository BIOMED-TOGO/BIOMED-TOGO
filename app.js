...
document.getElementById("orderForm")?.addEventListener("submit",e=>{e.preventDefault();let n=document.getElementById("name").value,p=document.getElementById("phone").value,i=document.getElementById("items").value;let msg=`Bonjour BIOMED-TOGO,%0A%0AJe souhaite passer une commande.%0A%0ANom/Structure : ${encodeURIComponent(n)}%0ATéléphone : ${encodeURIComponent(p)}%0ABesoin : ${encodeURIComponent(i)}%0A%0AMerci.`;window.open("https://wa.me/22800000000?text="+msg,"_blank")});
